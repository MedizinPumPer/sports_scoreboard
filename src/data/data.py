...
class Data:
    ...
    def __parse_today(self):
        ...
        noon = datetime.strptime("00:00", "%H:%M").replace(year=today.year, month=today.month,
                                                        day=today.day)
    ...
    def refresh_games(self):
        ...
        while attempts_remaining > 0:
            try:
                self.games = nfl_api.day(self.year, self.month, self.day)
    ...
    def refresh_overview(self):
        ...
        while attempts_remaining > 0:
            try:
                self.overview = nfl_api.overview(self.current_game_id)
    ...
    def refresh_standings(self):
        ...
        while attempts_remaining > 0:
            try:
                self.standings = nfl_api.standings()
                break
    ...
    ## Playoffs
    ## disabled for NFL (dont know why)
    ...
    #             self.playoffs = nfl_api.playoff(self.status.season_id)
